...
func _enter_tree() -> void:
	current_map = NavigationServer2D.map_create()
	NavigationServer2D.map_set_active(current_map, true)

func _ready() -> void:
	navigation_mesh = NavigationPolygon.new()
	NavigationServer2D.map_set_cell_size(current_map, 0.00999999977648)
	navigation_mesh.cell_size = 0.00999999977648
	navigation_mesh.agent_radius = 20
	...
	NavigationServer2D.region_set_map(region_rid, current_map)
